...
public class Personne implements Comparable<Personne> {
	...
	public boolean equals(Object o) {
		...
		return civilite_ == personne.civilite_ && Objects.equals(nom_, personne.nom_) && Objects.equals(prenom_, personne.prenom_);
	}

	public int compareTo(Personne personne) { return nom_.compareTo(personne.nom_); }
